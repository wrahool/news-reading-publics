...
latex_table_regionmean <- stargazer(international_mean_lm, national_mean_lm, regional_mean_lm,
          align = TRUE,
...
latex_table_regionmedian <- stargazer(international_median_lm, national_median_lm, regional_median_lm, 
