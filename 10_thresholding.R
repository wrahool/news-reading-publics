...
plot(observed.g, edge.color="orange", vertex.color="gray", vertex.label=NA,
     layout = l)
...
thresholds = c(0.009, 0.011, 0.026, 0.043, 0.052, 0.057, 0.147, 0.188, 0.261)
...
for(threshold in thresholds) {
  ...
  plot(observed.g, vertex.label = NA, main = paste0("tau = ", threshold))
}
