...
WT = cluster_walktrap(g, weights = E(g)$shared_audience)
...
write.csv(comm_network_EL, "03_Auxiliary/multilevel_community_EL_resolution.csv", row.names = F)
write.csv(interlevel_map, "03_Auxiliary/interlevel_map_resolution.csv", row.names = F)

save(comm_list, comm_list2_WT, file = "04_RData/06_multilevel_walktrap_communities_resolution.Rdata")
